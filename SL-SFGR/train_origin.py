...
if __name__ == "__main__":
    ...
    parser.add_argument('-c', '--config', type=str, default='config/diffuseMorph_train_3D_o.json',
                        help='JSON file for configuration')
    parser.add_argument('-p', '--phase', type=str, choices=['train', 'test'],
                        help='Run either train(training) or val(generation)', default='train')
    parser.add_argument('-gpu', '--gpu_ids', type=str, default='3,4,5,6')
    ...
    if opt['phase'] == 'train':
        ...
        while current_epoch < n_epoch:
            ...
            for istep, train_data in enumerate(train_loader):
                ...
                diffusion.optimize_parameters_origin()
                # log
