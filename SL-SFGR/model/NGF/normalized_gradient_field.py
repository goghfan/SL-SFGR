...
from model.NGF.kernels import gauss_kernel_1d, gauss_kernel_2d, gauss_kernel_3d
from model.NGF.kernels import gradient_kernel_1d, gradient_kernel_2d, gradient_kernel_3d
from model.NGF.kernels import spatial_filter_nd
...
if __name__ == '__main__':
    a = torch.randn(1,1,128,160,192)
    b = torch.randn(1,1,128,160,192)
    NGF = NormalizedGradientField3d(mm_spacing=[1.6,1.6,1.6],reduction='mean')
    result = NGF(a,b)
    print(result)

    # a = torch.randn(192,160,192)
    # b = torch.randn(192,160,192)
    # NGF = NGFLoss(a,b)
    # result = NGF.ngf_loss()
    # print(result)