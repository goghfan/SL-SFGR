...
from model.diffusion_net_3D.attnunet import UnetConv3,UnetGridGatingSignal,GridAttentionBlock3D,UnetUp3
...
class Seg_Reg_Encoder(nn.Module):
    ...
    def forward(self,x_in):
        ...
        out_seg1 = self.seg_block1(input)
        out_reg1 = self.reg_block1(input)
        out_seg1,out_reg1 = self.cross1(out_seg1,out_reg1)

        out_seg2 = self.seg_block2(out_seg1)
        out_reg2 = self.reg_block2(out_reg1)
        out_seg2,out_reg2 = self.cross2(out_seg2,out_reg2)
        out_seg3 = self.seg_block3(out_seg2)
        out_reg3 = self.reg_block3(out_reg2)
        out_seg3,out_reg3 = self.cross3(out_seg3,out_reg3)
        return out_seg1,out_seg2,out_seg3,out_reg1,out_reg2,out_reg3
...
class pivit(nn.Module):
    ...
    def __init__(self, size=(192,192,160), in_channel=1, first_channel=32):
        ...
        #seg_network
        #---------------------------------------------------
        self.encoderconv4 = UnetConv3(32, 64)
        self.maxpool4 = nn.MaxPool3d(kernel_size=(2, 2, 2))
        #---------------------------------------------------
        self.encoderconv5 = UnetConv3(64, 128)
        ...
        self.attentionblock5 = GridAttentionBlock3D(64, 128)
        self.attentionblock4 = GridAttentionBlock3D(32, 128)
        self.attentionblock3 = GridAttentionBlock3D(32, 128)
        self.attentionblock2 = GridAttentionBlock3D(32, 128)

        self.up_concat5 = UnetUp3(64, 32)
        self.up_concat4 = UnetUp3(32, 32)
        self.up_concat3 = UnetUp3(32, 32)
        self.up_concat2 = UnetUp3(32, 32)
        self.up_concat1 = UnetUp3(32, 4)

        self.out_conv = nn.Conv3d(4, 12, 1)
    ...
    def forward(self, x_in):               
        ...
        x_en1,x_en2,x_en3,fxy1,fxy2,fxy3=self.seg_reg_encoder(x_in)
        ...
        gating = self.gating(x_en5)

        att5 = self.attentionblock5(x_en4, x_en5)
        att4 = self.attentionblock4(x_en3, x_en5)
        att3 = self.attentionblock3(x_en2, x_en5)
        att2 = self.attentionblock2(x_en1, x_en5)

        up5 = self.up_concat5(att5, x_en5)
