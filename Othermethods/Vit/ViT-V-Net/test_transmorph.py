...
def main():
    ...
    data = {'M':moving,'F':fixed,'ML':moving_label,'FL':fixed_label}
    with open('vit_result.txt','a+') as f:
        with torch.no_grad():
            ...
            sitk.WriteImage( final_flow,'/root/autodl-tmp/BIBM2024/ViT-V-Net_for_3D_Image_Registration_Pytorch/ViT-V-Net/transmorph/'+'OAS30028_MR_d1260_to_OAS30004_MR_d3457'+'_flow.nii.gz')
            sitk.WriteImage( warped,'/root/autodl-tmp/BIBM2024/ViT-V-Net_for_3D_Image_Registration_Pytorch/ViT-V-Net/transmorph/'+'OAS30028_MR_d1260_to_OAS30004_MR_d3457'+'_warped.nii.gz')
            # sitk.WriteImage( warped_mask,'/root/autodl-tmp/BIBM2024/ViT-V-Net_for_3D_Image_Registration_Pytorch/ViT-V-Net/'+'OAS30028_MR_d1260_to_OAS30004_MR_d3457'+'_warped_mask.nii.gz')
