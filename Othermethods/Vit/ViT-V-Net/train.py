...
def main():
    batch_size = 1
    train_dir = '/home/vrdoc/GF/lung_registration/data/'
    val_dir = '/home/vrdoc/GF/lung_registration/data/'
    save_dir = '/home/vrdoc/GF/lung_registration/BaseLine/registration/ViT-V-Net_for_3D_Image_Registration_Pytorch/result/'
    lr = 0.0001
    epoch_start = 0
    max_epoch = 200
    cont_training = False
    ...
    # val_set = data.create_dataset(train_dir,trainortest='validation')
    # train_loader = DataLoader(train_set, batch_size=batch_size, shuffle=True, num_workers=4, pin_memory=True)
    # val_loader = data.create_dataloader(val_set, batchSize, phase)
